 ...
 * {@hide}
 */
public class MT8173 extends RIL implements CommandsInterface {
    ...
    public MT8173(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
    }

    public MT8173(Context context, int preferredNetworkType,
